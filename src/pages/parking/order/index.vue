    ...
    <div class="parking-container">
      ...
      <div class="local-content">
        ...
        <div class="parking-content">
          <p class="parking-title">{{ orderInfo.parkName }}车位：{{ orderInfo.parkNum }}</p>
...
<script>
import { handOrderParkLot, handStartOrder, handLoadLockState } from '../../../api/parking';
...
export default {
  ...
  methods: {
    ...
    finish() {
      ...
      wx.navigateTo({ url: url + '?orderId=' + this.orderInfo.id })
    },
    turnToNav() {
      console.log(this.orderInfo);
      wx.navigateTo({ url: '../navgation/main?info=' + JSON.stringify(this.orderInfo) })
    }
  },
  onShow(options) {
